...
<!doctype html>
<html>
  <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; background:#0a0a0a; color:#e5e7eb; margin:0; padding:32px;">
    <div style="max-width:560px; margin:0 auto; background:#111; border:1px solid #1e1e1e; border-radius:12px; padding:32px;">
      <h1 style="font-size:22px; color:#c9a84c; margin:0 0 12px;">You're in.</h1>
      ...
      <p style="font-size:14px; line-height:1.6; color:#9ca3af; margin:24px 0 0; border-top:1px solid #1e1e1e; padding-top:16px;">
        — Mario<br />
        <a href="${siteUrl}" style="color:#c9a84c; text-decoration:none;">buyorbesold.com</a>
      </p>
      <p style="font-size:12px; line-height:1.5; color:#6b7280; margin:24px 0 0; font-style:italic;">
